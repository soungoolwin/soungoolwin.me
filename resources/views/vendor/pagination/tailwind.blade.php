<div class="flex items-center pb-7">
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="Pagination Navigation" class="w-full flex justify-center">
            {{-- Previous Page Link --}}
            ...
            @else
                <a href="{{ $paginator->previousPageUrl() }}#blogs" rel="prev"
            ...
            @if ($paginator->hasMorePages())
                <a href="{{ $paginator->nextPageUrl() }}#blogs" rel="next"
